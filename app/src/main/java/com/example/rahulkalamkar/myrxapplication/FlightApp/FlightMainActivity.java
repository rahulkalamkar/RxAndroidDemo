package com.example.rahulkalamkar.myrxapplication.FlightApp;
...
import com.example.rahulkalamkar.myrxapplication.FlightApp.Network.ApiClient;
import com.example.rahulkalamkar.myrxapplication.FlightApp.Network.ApiService;
import com.example.rahulkalamkar.myrxapplication.FlightApp.Network.Model.Price;
import com.example.rahulkalamkar.myrxapplication.FlightApp.Network.Model.Ticket;
import com.example.rahulkalamkar.myrxapplication.FlightApp.View.TicketsAdapter;
...
public class FlightMainActivity extends AppCompatActivity implements TicketsAdapter.TicketsAdapterListener {
    private static final String TAG = FlightMainActivity.class.getSimpleName();
...
//        setSupportActionBar(toolbar);
        ...
        recyclerView.addItemDecoration(new FlightMainActivity.GridSpacingItemDecoration(1, dpToPx(5), true));
