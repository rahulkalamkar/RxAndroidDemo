package com.example.rahulkalamkar.myrxapplication.WebService;
...
import com.example.rahulkalamkar.myrxapplication.WebService.View.NotesAdapter;
import com.example.rahulkalamkar.myrxapplication.WebService.network.ApiClient;
import com.example.rahulkalamkar.myrxapplication.WebService.network.ApiService;
import com.example.rahulkalamkar.myrxapplication.WebService.network.model.Note;
import com.example.rahulkalamkar.myrxapplication.WebService.network.model.User;
import com.example.rahulkalamkar.myrxapplication.WebService.utils.MyDividerItemDecoration;
import com.example.rahulkalamkar.myrxapplication.WebService.utils.PrefUtils;
import com.example.rahulkalamkar.myrxapplication.WebService.utils.RecyclerTouchListener;
...
//        setSupportActionBar(toolbar);
                ...
                apiService.deleteNote(noteId)
                        ...
                        .subscribeWith(new DisposableCompletableObserver() {
                            ...
                            public void onComplete() {
                                ...
                                Toast.makeText(WebServiceActivity.this, "Note deleted!", Toast.LENGTH_SHORT).show();
    ...
    private void showNoteDialog(final boolean shouldUpdate, final Note note, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(WebServiceActivity.this);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(inputNote.getText().toString())) {
                    Toast.makeText(WebServiceActivity.this, "Enter note!", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    alertDialog.dismiss();
                }
